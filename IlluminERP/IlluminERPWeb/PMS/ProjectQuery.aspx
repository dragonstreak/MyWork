<%@ Page Title="" Language="VB" MasterPageFile="~/Master/IlluminMasterPage.master" AutoEventWireup="false" CodeFile="ProjectQuery.aspx.vb" Inherits="PMS_ProjectQuery" %>
		...
		<tr class="dgf" >
			<td colspan="6" >
                <telerik:RadButton ID="btnMyProposal" runat="server" Skin="Hay" 
                    Text="My Project" Font-Names="Arial" Font-Size="9pt" Width="120px">
...
<ExpandCollapseColumn Visible="True" FilterControlAltText="Filter ExpandColumn column"></ExpandCollapseColumn>
    ...
    <Columns>
        ...
        <telerik:GridBoundColumn UniqueName="columnContract" 
            Visible="False" FilterControlAltText="Filter columnContract column">
            <HeaderStyle HorizontalAlign="Center" Width="100px" />
            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                Font-Strikeout="False" Font-Underline="True" HorizontalAlign="Center" 
                Wrap="True" />
        </telerik:GridBoundColumn>
        <telerik:GridBoundColumn HeaderText="File Upload" 
            UniqueName="columnFileUpload" Visible="False" 
            FilterControlAltText="Filter columnFileUpload column">
            <HeaderStyle HorizontalAlign="Center" Width="100px" />
            <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" 
                Font-Strikeout="False" Font-Underline="False" HorizontalAlign="Center" 
                Wrap="True" />
