...
Partial Class PMS_ProjectTimingPage
    Inherits OperatePageBase
    Dim timingBLL As New PMS_ProjectTimingBLL
    ...
    Protected Overrides Sub SetForm()
        ...
        Dim timingList As List(Of PMS_ProjectTiming)
    ...
    Protected Sub RadGrid1_NeedDataSource(ByVal source As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles RadGrid1.NeedDataSource
        Dim timingList As List(Of PMS_ProjectTiming) = CType(ViewState("TimingList"), List(Of PMS_ProjectTiming))
    ...
    Protected Sub RadGrid1_UpdateCommand(ByVal source As Object, ByVal e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid1.UpdateCommand
        ...
        Dim currentTiming As PMS_ProjectTiming = timingList(currowRow)
        ...
        For Each column In e.Item.OwnerTableView.Columns
            If TypeOf column Is IGridEditableColumn Then
                ...
                If (editableCol.IsEditable) Then
                    ...
                    If (column.UniqueName = "StartDateColumn") Then
                        originText = currentTiming.StartDate.ToString
                        ...
                        currentTiming.StartDate = CType(editorText, DateTime)
                    ElseIf column.UniqueName = "EndDateColumn" Then
                        originText = currentTiming.EndDate.ToString
                        If String.Equals(editorText, originText) Then
                            Continue For
                        Else
                            needRefresh = True
                        ...
                        currentTiming.EndDate = CType(editorText, DateTime)
                    End If
                End If
            End If
        Next
        ...
        Try
            'Just for test
            For Each timing As PMS_ProjectTiming In timingList
        ...
        End Try
    End Sub
    Public Sub GetDays(ByVal timing As PMS_ProjectTiming)
    ...
    Protected Sub btnReturn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnReturn.Click
        Response.Redirect("ProjectQuotation.aspx?JobNumber=" + Page.Request.QueryString("JobNumber"))
    End Sub
