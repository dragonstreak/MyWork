<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ProposalTiming.aspx.vb"
    Inherits="PMS_ProposalTiming" %>
...
<body>
            ...
            <div style="padding: 5px">
                    <p style="text-align: center; padding-top: 0px">
                        ...
                        <button tabindex="1" id="btnImgExport" class="imgButton" onclick="javascript:Export()"  type="button" style="height: 43px; width: 90px;">
                         ...
                         <telerik:RadButton ID="btnReturnStage" runat="server"  Text ="Return Stage" Font-Names="Arial" 
    ...
    <div class="sharp color1" style="width: 97%; padding-left: 10px">
	    ...
	    -->	
                ...
                <telerik:RadGrid ID="RadGrid1" ShowStatusBar="True" runat="server" AutoGenerateColumns="False"
                    ...
                    <MasterTableView DataKeyNames="Id" EditMode="InPlace" CommandItemDisplay="None">
                        ...
                        <Columns>
                            ...
                            <%--<telerik:GridDateTimeColumn UniqueName="StartDateColumn" Visible="false" DataFormatString="{0:yyyy/M/d}"
                            ...
                            <telerik:GridDateTimeColumn UniqueName="EndDateColumn" Visible="false" DataFormatString="{0:yyyy/M/d}"
