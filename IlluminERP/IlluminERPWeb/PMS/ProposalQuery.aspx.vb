...
Partial Class ProposalQuery
    ...
    Private Sub initPageGrid()
        ...
        Select Case type.ToLower
            ...
            Case "team"
                Me.gridResult.Columns(Gridcolumn.teamAssignment).Visible = True
            Case "rating"
                Me.gridResult.Columns(Gridcolumn.ScaleRating).Visible = True
            Case "go"
    ...
    Private Sub InitCombobox()
        ...
        ds = Me.ProjectStatusBLL.GetProjectStatusInfo
        If Not ds Is Nothing Then
    ...
    Protected Sub gridResult_ItemDataBound(ByVal sender As Object, ByVal e As Telerik.Web.UI.GridItemEventArgs) Handles gridResult.ItemDataBound
        ...
        If e.Item.ItemType = GridItemType.Item Or e.Item.ItemType = Telerik.Web.UI.GridItemType.AlternatingItem Then
            ...
            DirectCast(e.Item, Telerik.Web.UI.GridDataItem).Item("columnEdit").Text = "<a href='Proposal.aspx?OperateType=Modify&Proid=" & id & "'><B>Edit</B></a>"
            ...
            DirectCast(e.Item, Telerik.Web.UI.GridDataItem).Item("columnTeamAssignment").Text = "<a href='#' onclick=javascript:openWin('" + "TeamAssignment.aspx?proid=" + id + "') >Assignment</a>"
            DirectCast(e.Item, Telerik.Web.UI.GridDataItem).Item("columnRating").Text = "<a href='#' onclick=javascript:openWin('" + "ProposalRating.aspx?proid=" + id + "') >Rating</a>"
    ...
    Private Function GetProposalInfobyId(ByVal ProId As Integer) As Boolean
        Return False
