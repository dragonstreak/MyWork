...
Partial Class PMS_ProjectQuotationPage
    Inherits OperatePageBase
    Dim quotationBLL As New PMS_ProjectQuotationBLL
    ...
    Protected Overrides Sub SetForm()
        ...
        Dim quotationList As List(Of PMS_ProjectQuotation)
    ...
    Protected Sub RadGrid1_NeedDataSource(ByVal source As Object, ByVal e As Telerik.Web.UI.GridNeedDataSourceEventArgs) Handles RadGrid1.NeedDataSource
        Dim quotationList As List(Of PMS_ProjectQuotation) = CType(ViewState("QuotationList"), List(Of PMS_ProjectQuotation))
    ...
    Protected Sub RadGrid1_UpdateCommand(ByVal source As Object, ByVal e As Telerik.Web.UI.GridCommandEventArgs) Handles RadGrid1.UpdateCommand
        ...
        Dim currentQuotation As PMS_ProjectQuotation = quotationList(currowRow)
    ...
    '    Dim quotationList As List(Of PMS_ProjectQuotation) = DirectCast(DirectCast(sender, RadGrid).DataSource, List(Of PMS_ProjectQuotation))
    '    Dim value As Double = 0
    '    For Each quotation As PMS_ProjectQuotation In quotationList
    ...
    Private Sub CalcTotal(ByVal quotationList As List(Of PMS_ProjectQuotation), ByVal feeType As String)
    ...
    End Sub
    Private Function GetQuotationDescription(ByVal quotationList As List(Of PMS_ProjectQuotation)) As List(Of String)
        'Dim quotationList As List(Of PMS_ProjectQuotation) = CType(ViewState("QuotationList"), List(Of PMS_ProjectQuotation))
        ...
        Dim subList As List(Of List(Of PMS_ProjectQuotation)) = GetOptionalQuotationCollection(quotationList)
        If subList Is Nothing Then
            Return descriptionList
        End If
        Dim subListWithOrder = From list In subList Order By list.Count Ascending Select list
        For Each optionalQuotationList As List(Of PMS_ProjectQuotation) In subListWithOrder
            Dim taskDescription As String = "Qutation contain "
            Dim fee As Decimal = totalQuotationWithoutOptional
            For Each optionalQuotation As PMS_ProjectQuotation In optionalQuotationList
        ...
        Return descriptionList
    End Function
    Private Function GetActuralQuotationDescription(ByVal quotationList As List(Of PMS_ProjectQuotation)) As List(Of String)
        'Dim quotationList As List(Of PMS_ProjectQuotation) = CType(ViewState("QuotationList"), List(Of PMS_ProjectQuotation))
        If quotationList Is Nothing Then
            Return Nothing
        End If
        ...
        Return descriptionList
    End Function
    Private Function GetOptionalQuotationCollection(ByVal quotationList As List(Of PMS_ProjectQuotation)) As List(Of List(Of PMS_ProjectQuotation))

        Dim subList As New List(Of List(Of PMS_ProjectQuotation))
        Dim optionalList As PMS_ProjectQuotation() = (From quotation In quotationList Where quotation.QuotationType = TaskType.OptionalTask.ToString() Select quotation).ToArray()
        ...
        setArr(position) = 1
        subList.Add(New List(Of PMS_ProjectQuotation))
        While (True)
