<%@ Page Language="VB" MasterPageFile="~/Master/IlluminMasterPage.master" AutoEventWireup="false" CodeFile="Proposal.aspx.vb" Inherits="PMS_Proposal" %>
                ...
                <tr>
                    ...
                    <td colspan="3"    >
                        <telerik:RadComboBox ID="cbStudytype" Runat="server" Skin="Windows7" 
                            ...
                            DropDownWidth="400px" CheckBoxes="True" 
             ...
             <telerik:RadWindowManager ID="RadWindowManager1" runat="server" 
                 ...
                 <Windows>
                   ...
                   <telerik:RadWindow ID="RadWindow3" runat="server" Width="650px" Height="450px" Modal="true"    EnableShadow="true"  
                      ...
                      <telerik:RadWindow ID="RadWindow4" runat="server" Width="720px" Height="550px" Modal="true"    EnableShadow="true"  
                        OnClientBeforeClose   ="onClientBeforeClose" >
...
//            }
            ...
            function openApplyClientWin(id) {
                var oWnd = window.radopen("AddClient.aspx?ProId=" + id, "RadWindow4");
                var bounds = oWnd.getWindowBounds();
                var x = bounds.x;
                var y = bounds.y;
                // oWnd.moveTo(x, 1);
