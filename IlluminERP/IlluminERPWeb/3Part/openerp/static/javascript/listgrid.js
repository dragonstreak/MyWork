...
MochiKit.Base.update(ListView.prototype, {
    ...
    save: function(id, prev_id) {
        ...
        for (var k in data) {
            if (k.indexOf(this.name + '../default.htm') == 0 || this.name == '_terp_list') {
                args[k] = data[k];
            }
        }
        ...
        parent_field = parent_field ? parent_field + '../default.htm' : '';
    ...
    remove: function(ids) {
        ...
        if(ids==0) {
            ...
            jQuery.post('listgrid/remove_o2m_defaults', {
                o2m_value: $o2m.val(),
