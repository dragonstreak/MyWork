...
Public Class PMS_ProjectQuotationBLL
    Dim dalFactory As EnterpriseDalFactory
    Dim iEntity As IPMS_ProjectQuotation
    Public Sub New()
        dalFactory = New EnterpriseDalFactory()

        iEntity = dalFactory.GetProduct(Of IPMS_ProjectQuotation, PMS_ProjectQuotationDAO)()
    End Sub
    Public Function GetEntityById(ByVal id As Integer) As PMS_ProjectQuotation
    ...
    End Function
    Public Function GetEntityList() As List(Of PMS_ProjectQuotation)
        Return iEntity.GetEntityList()
    End Function
    Public Function SaveEntity(ByVal entity As PMS_ProjectQuotation) As Integer
        Return iEntity.SaveEntity(entity)
    End Function
    'Public Function GetStageQuotation(ByVal stageId As Integer) As List(Of PMS_ProjectQuotation)
    '    Return iEntity.GetStageQuotation(stageId)
    'End Function
    'Public Function GetProposalQuotationList(ByVal proposalId As Integer) As List(Of PMS_ProjectQuotation)
    '    Return iEntity.GetProposalQuotationList(proposalId)
    'End Function
    Public Function GetQuotationListByJobNumber(ByVal jobNumber As String) As List(Of PMS_ProjectQuotation)
        Return iEntity.GetQuotationListByJobNumber(jobNumber)
    End Function
    Public Function CreateProjectQuotationByProposal(ByVal jobNumber As String) As Boolean
        Return iEntity.CreateProjectQuotationByProposal(jobNumber)
    End Function
    'Public Function GetQuotationListByComponentId(ByVal componentId As String) As List(Of PMS_ProjectQuotation)
    '    Return iEntity.GetQuotationListByComponentId(componentId)
    'End Function
    'Public Function GetQuotationStaticTaskList(ByVal stageId As Integer, ByVal proposalId As Integer, ByVal jobNumber As String) As List(Of PMS_ProjectQuotation)
    ...
    'Private Function CreateStaticTask(ByVal stageId As Integer, ByVal proposalId As Integer, ByVal TaskName As String, ByVal TaskOrder As Integer, ByVal jobNumber As String) As PMS_ProjectQuotation
    '    Dim task As New PMS_ProjectQuotation
    '    task.Id = -1
    ...
    '    Return task
    'End Function
    'Public Function GetInitQuotationListByMethodology(ByVal MethodologyId As String) As List(Of PMS_ProjectQuotation)
    '    Return iEntity.GetInitQuotationListByMethodology(MethodologyId)
    'End Function
    'Public Function SaveQuotationList(ByVal quotationList As List(Of PMS_ProjectQuotation)) As Boolean
    '    Return iEntity.SaveQuotationList(quotationList)
    'End Function
    'Public Function SetQuotationListStatus(ByVal list As List(Of PMS_ProjectQuotation), ByVal status As String) As Boolean
